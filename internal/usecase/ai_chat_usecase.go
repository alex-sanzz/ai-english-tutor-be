...
func (u *AiChatUseCase) ChatStream(ctx context.Context, sessionId string, message string, systemPrompt string, onChunk func(id string, chunk string) error, onFinish func(string) error, saveRequestMessage bool) error{
	err := u.chatService.ChatStream(ctx, sessionId, message, systemPrompt, onChunk, onFinish, saveRequestMessage)
